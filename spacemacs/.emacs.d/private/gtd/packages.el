...
(defun gtd/post-init-org ()
  ...
  (setq org-todo-state-tags-triggers
        (quote (("CANCELLED" ("CANCELLED" . t))
                ...
                ("DELEGATED" ("WAITING") ("CANCELLED") ("HOLD")) ;; rob 
                ("TODELEGATE" ("WAITING") ("CANCELLED") ("HOLD")) ;; rob 
                ("COMPLETE" ("WAITING") ("CANCELLED") ("HOLD")) ;; rob
  ...
  (setq org-capture-templates
        (quote (("t" "todo" entry (file "~/gtd/refile.org")
                ...
                ("n" "note" entry (file "~/gtd/refile.org")
                 "* %? :NOTE:\n%U\n%a\n" :clock-in t :clock-resume t)
                ("j" "Journal" entry (file+olp+datetree "~/gtd/diary.org")
                 "* %?\n%U\n" :clock-in t :clock-resume t)
                ("W" "org-protocol" entry (file "~/gtd/refile.org")
                 "* TODO Review %c\n%U\n" :immediate-finish t)
		("w" "Default template" entry (file "~/gtd/refile.org")
...
as the default task."
  ...
  (defvar bh/organization-task-id "7F8EC152-F0D8-4761-BAE5-3AAD15361383")
...
A prefix arg forces clock in of the default task."
  ...
  (setq org-global-properties (quote (("Effort_ALL" . "0:10 0:30 0:45 1:00 2:00 3:00 4:00 5:00 6:00 0:00")
                                      ("STYLE_ALL" . "habit"))))
